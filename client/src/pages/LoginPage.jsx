...

            {
              ...
              <div className='flex flex-col gap-2'>
                  {currState === "Sign up" ? (
                    ...
                    <p className='text-sm text-gray-600'>New Here??<span onClick={() => {setCurrState("Sign up")}} className='font-medium text-violet-500 cursor-pointer'>Create an account</span></p>
                  )}
              </div>
